...
Create the first file
    ...
    Create File  ${file_path}  This is some text in the file one!
    Should Exist  ${file_path}

Create the second file
    ${file_path} =  Join Path  ${output_directory}  ${directory_2}  ${file_2}
    Create File  ${file_path}  This is some text in the file two!
    Should Exist  ${file_path}

Create the third file
    ${file_path} =  Join Path  ${output_directory}  ${directory_2}  ${file_3}
    Create File  ${file_path}  This is some text in the file third!
    Should Exist  ${file_path}
